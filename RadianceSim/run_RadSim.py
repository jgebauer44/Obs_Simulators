...
def namelist_write(lat, lon):
	with open(f'namelist_site.input', 'w') as f:
		...
		f.write('model_dir            = /data/work2/wof/realtime/nature_run/15-03Z_5min/              # Director with the model data\n')
		f.write('model_prefix         = wrfnr_d01_    # Prefix for the model data files\n')
		...
		f.write('aeri_noise_file      = /home/tropoe/vip/src/tropoe/RadianceSim/AERI_avg_noise_20220301_20220430.nc\n')
...
while i < len(stations):
        ...
        os.system('python RadianceSim.py 20240508 namelist_site.input --output_dir /data/work/joshua.gebauer/SimObs/8May2024/obs_nc/mwr/')
        i+=1
