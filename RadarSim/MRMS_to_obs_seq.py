...
def write_dart_obs_seq(ref,ref0,lon,lat,z,dbz0_z,time,output_dir,ref_errors=5,dbz0_errors=7):
...
for k in range(ref.shape[0]):
    ...
    write_dart_obs_seq(ref_grid,ref0_grid,lons,lats,z,dbz0_levels,time[k],output_dir)