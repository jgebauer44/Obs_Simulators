...
tropoe_path = '/home/matthew.ammon/LidarSim/mesonet_site_LidarSims/20230419/SIM_Output/48_Sites/'

tfiles = []
tfiles = tfiles + sorted(glob.glob(tropoe_path + '*' + '_VAD.nc'))
output_dir = '/home/matthew.ammon/Obsseq/Lidar_Obsseq/'
print(tfiles)
r_cutoff = 4.0
max_height = 5000
z_spacing = 500
